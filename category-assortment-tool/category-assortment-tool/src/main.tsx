...
function App(){
 ...
 return <div className="app"><header><div><span className="eyebrow">RAMO · CATEGORY MANAGEMENT</span><h1>Assortment Tool <b>V0.2.1</b></h1></div><div className="privacy">● Procesamiento local · sin base de datos</div></header>
...
function Analysis({rows,allRows,counts,filter,setFilter}:{rows:AnalysisRow[];allRows:AnalysisRow[];counts:Record<Recommendation,number>;filter:'TODOS'|Recommendation;setFilter:(v:'TODOS'|Recommendation)=>void}){
 ...
 <div className="done">✓ V0.2.1: casos de descodificación corregidos y exportación Excel habilitada. Siguiente validación: comparar el resultado descargado contra el ejercicio manual.</div></section>
}
