...
function App(){
 ...
 return <div className="app"><header><div><span className="eyebrow">Caastoo · CATEGORY MANAGEMENT</span><h1>Assortment Tool <b>V0.3.2</b></h1></div><div className="privacy">● Procesamiento local · sin base de datos</div></header>
...
function Assortments({analysis,config}:{analysis:AnalysisRow[];config:AssortmentConfig}){
 ...
 <div className="done">✓ V0.3.2: generador de surtidos escalonados + exportación analítica completa activo. El porcentaje de reducción de cada transición es definido por el usuario.</div></section>
}
